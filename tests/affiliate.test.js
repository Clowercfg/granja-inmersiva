 ...
 *
 * Run from project root: cd server && node ../tests/affiliate.test.js
 */
...
const DB_PATH = join(__dirname, "..", "server", "data", "test-affiliate.db");
...
} from "../server/services/affiliateEngine.js";
import { AFFILIATE_CONFIG as CFG } from "../server/config/affiliate.js";
