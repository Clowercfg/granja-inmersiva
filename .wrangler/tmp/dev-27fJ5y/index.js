  ...
  async fetch(request, env2) {
    ...
    if (path === "/api/admin/deposits" && method === "POST") {
      ...
      if (!playerName || !amount || !currency || !network || !txHash || !adminName) {
        return error3("All fields are required");
      }
      const numAmount = parseFloat(amount);
      if (isNaN(numAmount) || numAmount <= 0) {
        return error3("Invalid amount");
      }
...
// .wrangler/tmp/bundle-49DELI/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-49DELI/middleware-loader.entry.ts
